            ...
            <div class="col-lg-0 col-md-0  flex-column align-items-left justify-content-left">
              ...
              <div class="d-flex  py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="badge border-success text-info">Nouvelle object</span>
                </a>
              ...
              <div class="card mb-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="nom" class="form-control" required id="Nom"></input>
                      <div class="invalid-feedback">Entrer un nom!</div>
                    </div>

                       <div class="form-floating mb-3">
                      <textarea class="form-control" class="badge border-success border-1 text-info" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"></textarea>
                      <label for="floatingTextarea" class="badge  border-1 text-info">Description</label>
                    </div>
              </select>
